...
# 注意这个页面提供的总是最新版 LFS 使用的补丁包
# 写此脚本时我使用的 LFS 版本是 v8.3-systemd
lfs_ptch_html = 'http://www.linuxfromscratch.org/lfs/view/stable-systemd/chapter03/patches.html'
ua = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36'
url_fn = 'wget-list-patches'
md5_fn = 'patches-md5sums'
...
# 请求页面
req = request.Request(lfs_ptch_html, headers={'User-Agent': ua})
